    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_location', models.CharField(max_length=255, verbose_name='المكان الحالي')),
                ('study_level', models.CharField(max_length=100, verbose_name='المستوى الدراسي')),
                ('curriculum', models.CharField(max_length=255, verbose_name='منهاج الدراسة')),
                ('program', models.CharField(max_length=255, verbose_name='البرنامج')),
                ('grade', models.CharField(max_length=100, verbose_name='الصف')),
                ('arabic_level', models.CharField(max_length=100, verbose_name='مستوى اللغة العربية')),
